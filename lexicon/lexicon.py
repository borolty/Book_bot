...
LEXICON = {
    "forward": ">>",
    "backward": "<<",
    "/start": "<b>Привет, читатель!</b>\n\nТы находишся в боте-библиотеке RBE (@ReadBookEverywhere_bot)\n\n"
              "В библиотеке находится пока одна книга, в будущем она будет пополняться"
            #   "В боте представлена "
    ...
    "/book_selection": 'Доступные книги:\n\n/1.Кант"Критика чистого разума" ',
